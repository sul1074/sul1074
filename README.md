...
- [**2025.12 ~ 2026.04 : 현장실습 (주식회사 엠케이디)**](https://github.com/sul1074/temp_repo_name)
  - 고객 피드백을 반영한 Spring Boot 기반 ERP 서비스 기능 확장 및 고도화
  - [AI 연동형 사내 드라이브 시스템 설계 및 개발](https://sul1074.tistory.com/122)
    - AI 문서 참조를 위한 벡터 임베딩 자동화 스케줄러 개발
    - 계층적 권한 상속 모델(ReBAC)을 적용한 자원 공유 아키텍처 설계 및 개발
  - 공유 링크를 통한 협업 채팅방 공유 기능 개발
